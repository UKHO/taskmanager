    ...
    { 
        ...
        { 
            ...
            exampleJson = "[ {\n  \"name\" : \"name\",\n  \"body\" : \"body\"\n}, {\n  \"name\" : \"name\",\n  \"body\" : \"body\"\n} ]";
                        ...
                        var example = exampleJson != null
                        ? JsonConvert.DeserializeObject<EventObjects>(exampleJson)
                        : default(EventObjects);            //TODO: Change the data returned
            return new ObjectResult(example);
        }
        ...
        [SwaggerResponse(statusCode: 406, type: typeof(DefaultErrorResponse), description: "Not acceptable.")]
        [SwaggerResponse(statusCode: 500, type: typeof(DefaultErrorResponse), description: "Internal Server Error.")]
        public virtual IActionResult PostEvent([FromRoute][Required]string eventName, [FromBody]Object body)
        { 
            //TODO: Uncomment the next line to return response 200 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
