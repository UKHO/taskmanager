$(document).ready(function() {
    ...
    $('#wfType *').prop('disabled', true);
    $('#DateSting *').prop('disabled', true);

    var tabIndex = 1;
    $("#frmWithdrawal *").filter(':visible').each(function (i) {
    ...
    $("#btnCreate").click(function() {
        ...
        var formData = $("#frmWithdrawal").serialize();

        $.ajax({
            type: "POST",
            url: "Withdrawal/?handler=Save",
