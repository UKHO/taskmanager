Describe "UKHO.SourceDocumentService Deployment Tests" {
    ...
    $adUser = "SVC_TMSdocSvcPoolUAT"
    $adGroup = "AG_PCPAT1IISSVC-GG"

    $adPermittedUsersGroup = "AG_TMAT1SDocSvcApi-DL"
    $adPermittedUsersGroupMembers = @("AG_PCPAT1IISSVC-GG")

    Context "Resource Planning Service API for AT1" {
