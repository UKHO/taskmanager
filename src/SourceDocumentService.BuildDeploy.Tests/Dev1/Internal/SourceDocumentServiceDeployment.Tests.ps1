Describe "UKHO.SourceDocumentService Deployment Tests" {
    ...
    $adUserDomain = "ENGINEERING"    
    $adUser = "SVC_TMSdocSvcPoolDev"
    $adGroup = "AG_PCPDEV1IISSVC-GG"

    $adPermittedUsersGroup = "AG_TMDEV1SDocSvcApi-DL"
    $adPermittedUsersGroupMembers = @("AG_PCPDEV1IISSVC-GG")

    Context "Resource Planning Service API for Dev1" {
