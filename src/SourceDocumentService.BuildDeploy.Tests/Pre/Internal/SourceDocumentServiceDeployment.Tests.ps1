Describe "UKHO.SourceDocumentService Deployment Tests" {
    ...
    $adUser = "SVC_TMSdocSvcPoolPre"
    $adGroup = "AG_PCPPREIISSVC-GG"

    $adPermittedUsersGroup = "AG_TMPreSDocSvcApi-DL"
    $adPermittedUsersGroupMembers = @("AG_PCPPREIISSVC-GG")

    Context "Resource Planning Service API for Pre" {
